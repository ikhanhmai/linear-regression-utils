...
import { SimpleNewPoint, MultipleNewPoint } from '@linear-regression-utils/shared';
...
import { useSimpleRegression, useMultipleRegression, useRegressionChart } from '@linear-regression-utils/shared';
