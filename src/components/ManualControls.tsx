...
export const ManualControls: React.FC<ManualControlsProps> = ({
  ...
  return (
    <div className="space-y-4">
      {/* Mode Selection */}
      <div className="bg-[#1E1E1E] p-4 rounded-xl shadow-sm border border-gray-700">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm font-medium text-gray-300">Manual Mode</span>
            <Tooltip content={
        ...
        <div className="bg-[#1E1E1E] p-6 rounded-xl shadow-sm border border-gray-700">
          <div className="space-y-6">
            <div className="flex items-center gap-2 mb-4">
              <h3 className="text-lg font-semibold text-gray-200">Line Parameters</h3>
              <Tooltip content={
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <label htmlFor="slope" className="text-sm font-medium text-gray-300 flex items-center gap-2">
                  Slope (β₁)
                  <Tooltip content={`
                ...
                <span className="text-sm text-gray-400 font-mono">{slope.toFixed(2)}</span>
              </div>
              <div className="flex items-center gap-4">
                ...
                <input
                  ...
                  onChange={(e) => onUpdate('slope', parseFloat(e.target.value))}
                  step="0.1"
                  className="w-24 px-3 py-1.5 text-sm text-gray-200 border border-gray-600 bg-[#2D2D2D] rounded-lg focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:ring-opacity-50 font-mono"
                />
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <label htmlFor="intercept" className="text-sm font-medium text-gray-300 flex items-center gap-2">
                  Intercept (β₀)
                  <Tooltip content={`
                ...
                <span className="text-sm text-gray-400 font-mono">{intercept.toFixed(2)}</span>
              </div>
              <div className="flex items-center gap-4">
                <input
                  type="range"
